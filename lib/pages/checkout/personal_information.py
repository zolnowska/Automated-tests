...
class PersonalInformation(Base):
    ...
    def click_customer_privacy(self):
        self.move_to_element(PersonalInformationLocators.CHECKBOX_CUSTOMER_PRIVACY)
        self.click(PersonalInformationLocators.CHECKBOX_CUSTOMER_PRIVACY)

    def click_term(self):
        self.move_to_element(PersonalInformationLocators.CHECKBOX_TERMS)
        self.click(PersonalInformationLocators.CHECKBOX_TERMS)
