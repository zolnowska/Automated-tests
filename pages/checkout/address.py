...
from locators.cart import address
...
class Addresses(Base):
    ...
    def full_addresses(self, address_delivery, city, postal_code, country, address_complement='', company='', vat='', phone=''):
    ...
    def click_same_address_for_invoice(self):
        self.wait_and_click(address.CHECKBOX_SAME_ADDRESS)

    def click_continue(self):
        self.wait_and_click(address.BTN_CONTINUE)
